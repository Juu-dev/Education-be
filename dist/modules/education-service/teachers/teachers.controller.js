...
let TeachersController = class TeachersController {
    ...
    findAll({ page, pageSize, }) {
        return this.teachersService.getListTeacher(page, pageSize);
    }
    findAllTeacher() {
    ...
    update(id, updateCategoryDto) {
        return this.teachersService.updateTeacher(id, updateCategoryDto);
    }
};
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TeachersController.prototype, "findAllTeacher", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, _n_decorators_1.Roles)([_n_constants_1.Permission.GET_CATEGORY]),
    (0, _n_decorators_1.AuthClaims)(),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], TeachersController.prototype, "findOneByUserId", null);
__decorate([
    (0, common_1.Patch)(':id'),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.UpdateTeacherDto]),
    __metadata("design:returntype", void 0)
