...
let TasksController = class TasksController {
    ...
    findAll({ page, pageSize, }) {
        return this.tasksService.getListTask(page, pageSize);
    }
    findAllWithSentMode(user, { page, pageSize, }) {
    ...
    findAllWithReceivedMode(user, { page, pageSize, }) {
        return this.tasksService.getListTaskWithSpecificMode({
            page,
            pageSize,
            mode: "received",
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TasksController.prototype, "findFiveLatest", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TasksController.prototype, "findAllWithSentMode", null);
__decorate([
    (0, common_1.Get)('received-mode'),
    (0, _n_decorators_1.AuthClaims)(),
    (0, swagger_1.ApiOkResponse)({
        isArray: true,
    }),
    ...
    __metadata("design:paramtypes", [Object, _n_dtos_1.PaginationParamsDto]),
    __metadata("design:returntype", void 0)
], TasksController.prototype, "findAllWithReceivedMode", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, _n_decorators_1.AuthClaims)(),
    openapi.ApiResponse({ status: 200 }),
